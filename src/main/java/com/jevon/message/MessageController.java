...
public class MessageController {
    ...
    @CrossOrigin
    @RequestMapping(value = "closeAllSupport.do",method = RequestMethod.GET)
    @ResponseBody
    public ServerResponse closeAllSupport(){
        wsMessageService.closeAllSupport();
        return ServerResponse.createBySuccessMessage("关闭旧连接成功");
    }
